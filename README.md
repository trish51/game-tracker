...
## Screenshots
![Screenshot of desktop version.](https://drive.google.com/file/d/1kG9vW8JHUYGgK-QgD2Def2a6D0Fhtux_/view?usp=drive_link)
![Screenshop of mobile version.](https://drive.google.com/file/d/1_GbSbuArpUf6M0Dsj4Sd-PeB8_8LKged/view?usp=drive_link)
...
## Mobile Experience
The site was designed to work on mobile devices, even though its a desktop first site.  Some mobile features that are not exlusive to the desktop version inlcude:
...
- **Platform Tags:** Automatically detect what platforms games are availible on allows users to manually assign tags to show what platform they are playing on.
...
## License
This project is currently under Exclusive Copyright. You are free to view the code for educational purposes, but reproduction or redistribution is restricted.
